...
describe('utils', () => {
  ...
  describe('#isAddress', () => {
    ...
    it('returns the checksummed address', () => {
      expect(isAddress('0xD45c702EfeF25d2c118db64d52b61183d2f0f4CD')).toBe('0xD45c702EfeF25d2c118db64d52b61183d2f0f4CD')
      expect(isAddress('0xD45c702EfeF25d2c118db64d52b61183d2f0f4CD')).toBe('0xD45c702EfeF25d2c118db64d52b61183d2f0f4CD')
    })

    it('succeeds even without prefix', () => {
      expect(isAddress('f164fc0ec4e93095b804a4795bbe1e041497b92a')).toBe('0xD45c702EfeF25d2c118db64d52b61183d2f0f4CD')
    })
  ...
  describe('#shortenAddress', () => {
    ...
    it('truncates middle characters', () => {
      expect(shortenAddress('0xD45c702EfeF25d2c118db64d52b61183d2f0f4CD')).toBe('0xf164...b92a')
    })
